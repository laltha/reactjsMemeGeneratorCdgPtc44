...
class MemeGenerator extends Component {
  state = {
    ...
    backgroundImageUrl: '', // Correct state variable name for background image URL
    topText: '',
    bottomText: '',
    activeFontSizeId: '',
  }
  ...
  onGenerateMeme = event => {
    ...
    this.setState({
      backgroundImageUrl: backgroundImageUrlInput, // Update backgroundImageUrl with input value
  ...
  renderMeme = () => {
    const {
      backgroundImageUrl, // Correct state variable name
      topText,
      bottomText,
      activeFontSizeId,
    } = this.state
